...
class TestRequests1:
    ...
    def test_get(self):
        ...
        res = RequestUtil('base','base_gzh_url').send_request('get', url, params=params)
    ...
    def test_post2(self):
        ...
        res = RequestUtil('base','base_gzh_url').send_request('post', url, data=json.dumps(data))
        print(res.text)
    ...
    def test_file_upload(self):
        ...
        res = RequestUtil('base','base_gzh_url').send_request('post', url, files=data)
        print(res.text)
